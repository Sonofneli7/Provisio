...
<div class="container-fluid ">    
            <div class="row" id="footer">
                ...
                <div class="col-lg-3 bg-primary" id="secondDiv">
                    ...
                    <a href="aboutus.jsp" class="d-inline-block mb-2 text-white text-decoration-none">About</a><br>
                    <a href="contactus.jsp" class="d-inline-block mb-2 text-white text-decoration-none">Contact Us</a><br>
